...
public class MessageDeframer implements Closeable, Deframer {
  ...
  public void request(int numMessages) {
    ...
    logger.debug("request {}", numMessages);
    if (isClosed()) {
      logger.debug("request {} ignored as deframer is closed", numMessages);
      return;
    }
    pendingDeliveries += numMessages;
    deliver();
    logger.debug("request {} complete", numMessages);
  }

  @Override
  public void deframe(ReadableBuffer data) {
    logger.debug("deframe {} bytes", data.readableBytes());
  ...
  public void closeWhenComplete() {
    ...
    logger.debug("closeWhenComplete complete");
  }
  ...
  private void processHeader() {
    ...
    state = State.BODY;
    logger.debug("processHeader complete, body length {}", requiredLength);
  }
  ...
  private void processBody() {
    logger.debug("processBody of length {}", requiredLength);
    ...
    logger.debug("processBody complete");
  }
