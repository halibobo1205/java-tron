...
public class GetDelegatedResourceAccountIndexV2ServletTest {
  ...
  public void setUp() throws Exception {
    ...
    Field f = GetDelegatedResourceAccountIndexV2Servlet.class.getDeclaredField("wallet");
  ...
  public void testPost() throws Exception {
    ...
    assertTrue(!postContent.trim().isEmpty());
  }
  ...
  public void testGet() throws Exception {
    ...
    assertTrue(!getContent.trim().isEmpty());
  }
}
