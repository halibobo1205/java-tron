...
public class ParticipateAssetIssueServletTest {
  ...
  public void setUp() throws Exception {
    ...
    Field f = ParticipateAssetIssueServlet.class.getDeclaredField("wallet");
  ...
  public void testParticipateAssetIssue() throws Exception {
    String jsonParam = "{"
        ...
        + "\"to_address\": \"41B4750E2CD76E19DCA331BF5D089B71C3C2798548\","
        + "\"asset_name\": \"74657374\","
        + "\"amount\": 100"
        + "}";
