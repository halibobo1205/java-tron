...
public class GetAssetIssueListByNameServletTest {
  ...
  public void setUp() throws Exception {
    ...
    Field f = GetAssetIssueListByNameServlet.class.getDeclaredField("wallet");
  ...
  public void testGet() throws Exception {
    ...
    request.addParameter("value", "74657374");
